document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('input', function(e) {
            ...
            if (input.classList.contains('error') || input.parentElement.querySelector('.form-error')) {
                validateField(input);
            }
        });
                ...
                fetch(action, options)
                    .then(function(response) {
                        if (response.ok) {
                            ...
                            successMessage.style.cssText = 'color: #38a169; font-size: 1rem; margin-top: 1rem; padding: 0.75rem; background: #f0fff4; border-radius: 0.375rem;';
                    ...
                    .catch(function() {
                        ...
                        errorMessage.style.cssText = 'color: #e53e3e; font-size: 1rem; margin-top: 1rem; padding: 0.75rem; background: #fff5f5; border-radius: 0.375rem;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '654c806c-ef6c-4932-b253-b31601a59aed',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '654c806c-ef6c-4932-b253-b31601a59aed';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '654c806c-ef6c-4932-b253-b31601a59aed';
